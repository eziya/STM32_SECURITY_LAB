...
2. Pressing 2 allows to test protections.
   ...
   - TAMPER test (#4): causes a reset if a tamper event is detected. In order to generate a tamper event, user has to
     connect PA0 (CN4.12) to GND (It may be enough to put your finger close to PA0 (CN4.12)). It may be better to
     have PA0 (CN4.12) connected to 3V3 before doing the transition to GND.
