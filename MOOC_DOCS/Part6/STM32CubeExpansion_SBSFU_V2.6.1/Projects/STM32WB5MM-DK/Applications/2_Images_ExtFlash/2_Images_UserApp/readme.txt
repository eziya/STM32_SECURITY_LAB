...
@par Directory contents
   ...
   - 2_Images_SBSFU/Inc/stm32wb5mm_dk_conf.h         BSP configuration file
...
Once executed, this user application gives access to a menu which allows:
   ...
   2 - to test protections (WRP, IWDG)
...
2. Pressing 2 allows to test protections.
   - CORRUPT IMAGE test (#1): causes a signature verification failure of the selected firmware image at next boot.
     The firmware image will be restored from the backup slot.
   ...
   - TAMPER test (#4): TAMPER protection is not activated on this board due to conflict with USER buttons and STMod+.
