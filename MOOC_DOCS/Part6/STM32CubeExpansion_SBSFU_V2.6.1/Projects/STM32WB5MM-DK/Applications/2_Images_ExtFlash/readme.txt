...
This example is configured for an external flash configuration with backup slot mechanism:
   - Download slot is mapped in external flash
   - Backup slot is mapped in external flash
   - Active slot is extended to all the internal flash free
   - External flash driver is integrated in sfu_low_level_flash_ext.c
