...
uint32_t cipherText[4] = {0xf3eed1bd, 0xb5d2a03c, 0x064b5a7e, 0x3db181f8};
uint32_t encrypted[4] = {0x0,};
uint32_t decrypted[4] = {0x0,};

uint32_t startTick, endTick, encTick, decTick;
