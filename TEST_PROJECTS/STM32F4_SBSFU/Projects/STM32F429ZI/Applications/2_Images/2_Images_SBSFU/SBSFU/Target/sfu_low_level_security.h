...
#define SFU_PROTECT_MPU_PERIPH_2_SIZE  MPU_REGION_SIZE_1KB /* 0x400 */
#define SFU_PROTECT_MPU_PERIPH_2_SREG  0x00U               /*!< All subregions activated */
#define SFU_PROTECT_MPU_PERIPH_2_PERM  MPU_REGION_PRIV_RW  /* priviedged rw  */
#define SFU_PROTECT_MPU_PERIPH_2_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define SFU_PROTECT_MPU_FLASHACC_SIZE  MPU_REGION_SIZE_2MB /* 2MB flash */
#define SFU_PROTECT_MPU_FLASHACC_SREG  0x00U               /*!< All subregions activated */
#define SFU_PROTECT_MPU_FLASHACC_PERM  MPU_REGION_FULL_ACCESS /* full access */
#define SFU_PROTECT_MPU_FLASHACC_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define SFU_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_256KB /* secure region 256KB before swap */
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x00U               /*!< All subregions activated */
#define SFU_PROTECT_MPU_FLASHEXE_PERM  MPU_REGION_PRIV_RO_URO /* read only */
#define SFU_PROTECT_MPU_FLASHEXE_EXECV MPU_INSTRUCTION_ACCESS_ENABLE /* able to execute */
...
#define SFU_PROTECT_MPU_HEADER_SIZE  MPU_REGION_SIZE_512B  /* header size is 512 bytes */
#define SFU_PROTECT_MPU_HEADER_PERM  MPU_REGION_PRIV_RW    /* privileged rw */
#define SFU_PROTECT_MPU_HEADER_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define SFU_PROTECT_MPU_SRAMACC_SREG  0xF8U                /*!<0b11111000 512 Kbytes / 8 * 3 ==>  192 Kbytes */
#define SFU_PROTECT_MPU_SRAMACC_PERM  MPU_REGION_FULL_ACCESS /* full access */
#define SFU_PROTECT_MPU_SRAMACC_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define SFU_PROTECT_MPU_SRAM_SE_SIZE  MPU_REGION_SIZE_4KB  /* SE region 4KB 0x1000 */
#define SFU_PROTECT_MPU_SRAM_SE_SREG  0x00U                /*!< All subregions activated */
#define SFU_PROTECT_MPU_SRAM_SE_PERM  MPU_REGION_PRIV_RW   /* privileged rw */
#define SFU_PROTECT_MPU_SRAM_SE_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define SFU_PROTECT_MPU_EXEC_SE_SIZE  MPU_REGION_SIZE_64KB /* SE region 64KB 0x10000 */
#define SFU_PROTECT_MPU_EXEC_SE_SREG  0x00U                /*!< All subregions activated */
#define SFU_PROTECT_MPU_EXEC_SE_PERM  MPU_REGION_PRIV_RO   /* privileged read only */
#define SFU_PROTECT_MPU_EXEC_SE_EXECV MPU_INSTRUCTION_ACCESS_ENABLE /* able to execute */
...
#define APP_PROTECT_MPU_PERIPH_1_SREG  0x83U               /*!< 0b10000011 4GB / 8 * 5 ==> only peripheral area allowed */
#define APP_PROTECT_MPU_PERIPH_1_PERM  MPU_REGION_FULL_ACCESS /* full access */
#define APP_PROTECT_MPU_PERIPH_1_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
...
#define APP_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_1MB /* 1st bank where active slot is located */
#define APP_PROTECT_MPU_FLASHEXE_SREG  0x04U               /*!< 0b00000100 subregion 0,1 (activated): SBSFU
                                                                           subregion 2 (de-activated) : Swap
                                                                           subregions 3,4,5,6,7 (activated) : active slot(s) */
#define APP_PROTECT_MPU_FLASHEXE_PERM  MPU_REGION_PRIV_RO_URO  /* read only */
#define APP_PROTECT_MPU_FLASHEXE_EXECV MPU_INSTRUCTION_ACCESS_ENABLE /* able to execute */
...
#define APP_PROTECT_MPU_RCCBBA_START (PERIPH_BB_BASE  + (RCC_BASE - PERIPH_BASE) * 32U ) /* bit banding area */
#define APP_PROTECT_MPU_RCCBBA_SREG  0x00U                 /*!< All subregions activated */
#define APP_PROTECT_MPU_RCCBBA_SIZE  MPU_REGION_SIZE_32KB
#define APP_PROTECT_MPU_RCCBBA_PERM  MPU_REGION_PRIV_RW    /* privileged read write */
#define APP_PROTECT_MPU_RCCBBA_EXECV MPU_INSTRUCTION_ACCESS_DISABLE /* not able to execute */
