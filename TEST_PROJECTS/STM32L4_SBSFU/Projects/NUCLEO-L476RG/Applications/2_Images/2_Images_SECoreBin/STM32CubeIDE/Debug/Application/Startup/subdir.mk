...
E:/Workspace/STM32_SECURITY_LAB/TEST_PROJECTS/STM32L4_SBSFU/Middlewares/ST/STM32_Secure_Engine/Core/se_stack_smuggler_GNU.s \
...
Application/Startup/se_stack_smuggler_GNU.o: E:/Workspace/STM32_SECURITY_LAB/TEST_PROJECTS/STM32L4_SBSFU/Middlewares/ST/STM32_Secure_Engine/Core/se_stack_smuggler_GNU.s Application/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -o "$@" "$<"
